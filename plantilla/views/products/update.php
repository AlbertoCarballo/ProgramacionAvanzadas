                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <form class="card-body" enctype="multipart/form-data" method="POST"
                            action="<?= BASE_PATH ?>app/ProductsController.php?id=<?=$products->id?>">
                            <div class="mb-3">
                                <label class="form-label">Product Name</label>
                                <input name="name" type="text" class="form-control" id="productName" required value="<?php echo htmlspecialchars($products->name); ?>">
                            </div>
                            <div class="mb-3">
                                <label for="productDescription" class="form-label">slug</label>
                                <input name="slug" class="form-control" id="productDescription" rows="3"
                                    required value="<?php echo htmlspecialchars($products->slug); ?>"></input>
                            </div>
                            <div class="mb-3">
                                <label for="productDescription" class="form-label">Descripción</label>
                                <textarea name="description" class="form-control" id="productDescription" rows="3"
                                    required><?php echo htmlspecialchars($products->description); ?></textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea name="features" class="form-control" id="productDescription" rows="3"
                                    required><?php echo htmlspecialchars($products->features); ?></textarea>
                            </div>
                            <div class="mb-3">
